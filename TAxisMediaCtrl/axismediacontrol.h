...
enum AMC_PLAYBACK_MODE
{
    AMC_PM_AUTO = 0,
    AMC_PM_LIVE = 1,
    AMC_PM_RECORDING = 2
};
enum AMC_FOCUS_WINDOW_MODE
{
    AMC_FW_DISABLED = 0,
    AMC_FW_NORMAL = 1,
    AMC_FW_PERSISTENT = 2
